    ...
    <CustomSessionProvider>
      <div className={` flex flex-col`} style={{ fontFamily: ruda.style.fontFamily, fontSize: sizing.globalFontSize }}>
        <nav style={{
          ...
          backgroundColor: colours.primary, paddingLeft: spacing.gaps.separateElement, paddingRight: spacing.gaps.separateElement
          ...
          <div className="leftSide flex items-center h-full" style={{ columnGap: spacing.gaps.groupedElement }}>
            ...
            <div className="hidden md:block flex-1 w-[1px] h-full" style={{ backgroundColor: changeColour(colours.primary).darken(8).toString() }}></div>

...
function LessonItem({ topic, currentInformationIntakeSummary, threadID }: { topic: string, currentInformationIntakeSummary: string, threadID: string }) {
    const [hovered, setHovered] = useState(false)
    return (
        <div className="flex gap-0 hover:" onMouseEnter={() => setHovered(true)} onMouseLeave={() => setHovered(false)} style={{
            borderRadius: '10px',
            ...
            <article className='flex flex-col'>
                ...
                <h3>{currentInformationIntakeSummary}</h3>

            ...
            <div className='flex flex-col' style={{ rowGap: spacing.gaps.separateElement }}>
                ...
                <fieldset className='flex flex-col' style={{ rowGap: spacing.gaps.separateElement }}>
                    <div className="flex flex-col w-full" style={{ rowGap: spacing.gaps.groupedElement }}>
                        ...
                        <Input ref={usernameRef} defaultValue="tgoulder4" className='py-[20px] w-full' type="text" id="usernameField" style={{ fontSize: sizing.globalFontSize, paddingLeft: spacing.gaps.separateElement, paddingRight: spacing.gaps.separateElement }} placeholder="Username" />
                    </div>
                    <div className="flex flex-col w-full" style={{ rowGap: spacing.gaps.groupedElement }}>
                        <label style={{ color: colours.textLegend }} className='font-bold' htmlFor="passwordField">Password</label>
                        <Input type="password" defaultValue="testPassword" ref={passwordRef} className='py-[20px] w-full' id="passwordField" style={{ fontSize: sizing.globalFontSize, paddingLeft: spacing.gaps.separateElement, paddingRight: spacing.gaps.separateElement }} placeholder="Password" />
                        {
                            errorMessage &&

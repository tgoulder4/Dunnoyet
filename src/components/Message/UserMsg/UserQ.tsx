            ...
            {closed ? (
              ...
              <>
                <Textarea
                  id={`questionInput`}
                  ref={questionRef}
                  className={`h-fit p-1 bg-primary border-primary/80 ring-0 text-white w-full max-w-[75%] max-h-fit text-2xl placeholder:text-[#135632] placeholder:font-bold ${merriweather.className} font-[400]  tracking-[-0.374px]`}
                  onChange={(e) => {

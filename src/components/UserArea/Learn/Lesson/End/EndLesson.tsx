...
function EndLesson({ subject, experiencePrior, experienceNow }: { subject: string, experiencePrior: number, experienceNow: number }) {
    ...
    const levelNext = getLevel(experienceNext);
            ...
            <div className="flex flex-col gap-4">
                <div className="flex flex-col gap-3">
                    <svg width="92" height="92" viewBox="0 0 92 92" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M68.9998 47.9165V38.3332C68.9998 36.2998 68.1921 34.3498 66.7543 32.912C65.3165 31.4742 63.3665 30.6665 61.3332 30.6665C59.2998 30.6665 57.3498 31.4742 55.912 32.912C54.4742 34.3498 53.6665 36.2998 53.6665 38.3332V43.6998" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M53.6668 42.1668V34.5002C53.6668 32.4668 52.8591 30.5168 51.4213 29.079C49.9835 27.6412 48.0335 26.8335 46.0002 26.8335C43.9668 26.8335 42.0168 27.6412 40.579 29.079C39.1412 30.5168 38.3335 32.4668 38.3335 34.5002V42.1668" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />
                        <path d="M38.3333 40.25V19.1667C38.3333 17.1333 37.5256 15.1833 36.0878 13.7455C34.65 12.3077 32.7 11.5 30.6667 11.5C28.6333 11.5 26.6833 12.3077 25.2455 13.7455C23.8077 15.1833 23 17.1333 23 19.1667V53.6667" stroke="white" stroke-width="5" stroke-linecap="round" stroke-linejoin="round" />

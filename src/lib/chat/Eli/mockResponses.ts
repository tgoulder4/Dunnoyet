            ...
            const payloadResponseForNewQ: any | string = await new Promise<any | string>((resolve, reject) => {
                setTimeout(() => {
                    resolve({
                        newMessages: [
                            {
                                id: "ID2", //example id generated by server on message creation
                                content: '\n' +
                            ...
                            {
                                id: "ID3", //example id generated by server on message creation
                                splitResponse: {
        ...
        case 'Reply':
            const payloadResponseForReply: any | string = await new Promise<any | string>((resolve, reject) => {
                setTimeout(() => {
                    resolve({
                        newMessages: [
                            //user said 'what wave like behaviour do they exhibit?'
                            {
                                splitResponse: {
                                    text: 'Great question, but not quite. Electrons diffract and interfere with each other, just like waves. This is called [electron diffraction].',
                                    active: false
                                },
                                role: 'eli',
                                eliResponseType: 'General'
                        ...
                        metadata: {
                            ...
                            threads: [
                                [
                                    ...
                                    splitResponse: {
                                        text: 'Great question! Electrons diffract and interfere with each other, just like waves. This is called [electron diffraction].',
                                        active: false
                                    },
                                    role: 'eli',
                                    eliResponseType: 'General'
                            ...
                            knowledgePointChain: [
                                {
                                    confidence: 4,
                                    lessonId: '65dbe7799c9c2a30ecbe6193',
                                    pointInSolitude: 'Electron diffraction involves constructive and destructive interference.',
                                    pointInChain: '',
                                    source: 'offered',
                                    TwoDCoOrdinates: [87.142, 62.1415],
                                    vectorEmbedding: [
                                        -0.022827767, 0.0018153265, -0.037418827, 0.05640204,
                                        0.018287312, 0.054166034, -0.0005283413, 0.050606683,
                                        0.008151144, 0.0446288, 0.004771471, -0.001528696,
                                ...
                                },
                                {
                                    confidence: 2,
                                    lessonId: '65dbe7799c9c2a30ecbe6193',
                                    pointInSolitude: 'This helps explain phenomena in the world.',
                                    pointInChain: '',
                                    source: 'offered',
                                    TwoDCoOrdinates: [97.142, 22.1415],
                                    vectorEmbedding: [
                                        -0.022827767, 0.0018153265, -0.037418827, 0.05640204,
                                        0.018287312, 0.054166034, -0.0005283413, 0.050606683,
                                        0.008151144, 0.0446288, 0.004771471, -0.001528696,
                    ...
                    setTimeout(() => {
                        resolve({
                            newMessages: [
                                ...
                                {
                                    splitResponse: {
                                        text: 'Electron diffraction involves the diffraction of electrons as they pass through a crystal lattice, forming green rings on a screen.',
                                        active: false
                                    },
                                    role: 'eli',
                                    eliResponseType: 'General'
                    ...
                    setTimeout(() => {
                        resolve({
                            newMessages: [
                                ...
                                {
                                    splitResponse: {
                                        text: 'Now that you understand that, this means that electrons can behave like particles in some situations and like waves in others.',
                                        active: false
                                    },
                                    role: 'eli',
                                    eliResponseType: 'General'
                            ...
                            metadata: {
                                ...
                                knowledgePointChain: [
                                    ...
                                    },
                                    {
                                        confidence: 4,
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Wavelength can be calculated using debroglie.',
                                        pointInChain: '',
                                        source: 'offered',
                                        TwoDCoOrdinates: [41.842, 3.8415],
                                        vectorEmbedding: [
                                ...
                                knowledgePointChain: [
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Electron diffraction involves constructive and destructive interference.',
                                        pointInChain: 'Electron diffraction involves constructive and destructive interference...',
                                        source: 'offered',
                                        TwoDCoOrdinates: [87.142, 62.1415],
                                        vectorEmbedding: [
                                            -0.022827767, 0.0018153265, -0.037418827, 0.05640204,
                                    ...
                                    },
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'This helps explain phenomena in the world.',
                                        pointInChain: '...which helps explain phenomena in the world...',
                                        source: 'offered',
                                        TwoDCoOrdinates: [97.142, 22.1415],
                                        vectorEmbedding: [
                                            -0.022827767, 0.0018153265, -0.037418827, 0.05640204,
                                    ...
                                    },
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Electrons exhibit wave-like behavior due to wave-particle duality.',
                                        pointInChain: '...and is an example of wave-particle duality. ...',
                                        source: 'offered',
                                        TwoDCoOrdinates: [63.142, 31.1415],
                                        vectorEmbedding: [
                                            -0.022827767, 0.0018153265, -0.037418827, 0.05640204,
                                    ...
                                    },
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Electrons can act as waves in quantum mechanics.',
                                        pointInChain: '... They can act as waves ...',
                                        source: 'offered',
                                        TwoDCoOrdinates: [32.642, 35.3415],
                                        vectorEmbedding: [
                                            -0.027314743, 0.029712684, -0.060951333, 0.048351236, 0.027096748,
                                    ...
                                    },
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Wavelength can be calculated using debroglie.',
                                        pointInChain: '... where the wavelength can be calculated using De-brogile equation. ...',
                                        source: 'offered',
                                        TwoDCoOrdinates: [41.842, 3.8415],
                                        vectorEmbedding: [
                                            -0.029410908, 0.021849506, -0.050965812, 0.060343914,
                                    ...
                                    },
                                    {
                                        ...
                                        lessonId: '65dbe7799c9c2a30ecbe6193',
                                        pointInSolitude: 'Electrons behave like waves, explaining phenomena in the microscopic world.',
                                        pointInChain: '... and this helps explain phenomena in the microscopic world.',
                                        source: 'offered',
                                        TwoDCoOrdinates: [23.142, 13.1415],
                                        vectorEmbedding: [
                                            -0.02287109, 0.019203713, -0.06841323, 0.038051803,
